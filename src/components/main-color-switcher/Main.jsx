      ...
      <div className="shadow-md fixed bottom-0 right-0 box border rounded-full h-12 px-5 flex items-center justify-center z-50 mb-10 mr-52">
        ...
        <a
          ...
          className={classnames({
            "block w-8 h-8 cursor-pointer bg-purple-800 rounded-full border-4 mr-1 hover:border-slate-200": true,
        ...
        <a
          ...
          className={classnames({
            "block w-8 h-8 cursor-pointer bg-cyan-700 rounded-full border-4 mr-1 hover:border-slate-200": true,
            "border-slate-300 dark:border-darkmode-800/80":
              colorScheme == "theme-1",
        ...
        <a
          ...
          className={classnames({
            "block w-8 h-8 cursor-pointer bg-fuchsia-700 rounded-full border-4 mr-1 hover:border-slate-200": true,
            "border-slate-300 dark:border-darkmode-800/80":
              colorScheme == "theme-2",
        ...
        <a
          ...
          className={classnames({
            "block w-8 h-8 cursor-pointer bg-yellow-600 rounded-full border-4 mr-1 hover:border-slate-200": true,
            "border-slate-300 dark:border-darkmode-800/80":
              colorScheme == "theme-3",
        ...
        <a
          ...
          className={classnames({
            "block w-8 h-8 cursor-pointer bg-lime-700 rounded-full border-4 hover:border-slate-200": true,
            "border-slate-300 dark:border-darkmode-800/80":
              colorScheme == "theme-4",
